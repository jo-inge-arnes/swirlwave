...
public class PeersDbTest {
    ...
    public void when_updating_then_correct_peer_should_be_updated() throws Exception {
        ...
        peer2.setLastKnownAddress("address_updated_ok");
        peer2.setPhoneNumber("phone_updated_ok");
        ...
        assertEquals(peer.getPhoneNumber(), selectedPeer.getPhoneNumber());
        assertEquals(peer.getLastKnownAddress(), selectedPeer.getLastKnownAddress());
        ...
        assertEquals("phone_updated_ok", selectedPeer.getPhoneNumber());
        assertEquals("address_updated_ok", selectedPeer.getLastKnownAddress());
    }
}
